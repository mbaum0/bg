...
void DStats_update(ViewManager* vm, Snippet* snippet, void* data){
    ...
    extern DStats stats;
    char debugText[200];
    float fps, gameHeight, gameWidth, pipHeight, pipWidth, checkerHeight, checkerWidth, checkerRenderedHeight, checkerRenderedWidth;;
    fps = stats.fps;
    ...
    sprintf(debugText, "FPS: %f\ngame height: %f\ngame width: %f\npipHeight: %f\npipWidth: %f\ncHeight: %f\ncWidth: %f\ncRenderW: %f\ncRenderH: %f", fps, gameHeight, gameWidth, pipHeight, pipWidth, checkerHeight, checkerWidth, checkerRenderedWidth, checkerRenderedHeight);
...
void DStats_create(void){
    extern DStats stats;
    char debugText[200];
    //sprintf(debugText, "FPS: %f\ngame height: %f\ngame width: %f\npipHeight: %f\npipWidth: %f\ncHeight: %f\ncWidth: %f ", stats.fps, stats.gameHeight, stats.gameWidth, stats.pipHeight, stats.pipWidth, stats.checkerHeight, stats.checkerWidth);
    sprintf(debugText, "  ");
